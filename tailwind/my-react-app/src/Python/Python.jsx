...
const Python = () => {
  return (
     <div className='flex items-center flex-col justify-center bg-slate-200 h-[600px] w-full justify-center flex-wrap font-bold text-black'>
    <div className='flex flex-col items-center'  >
<h1 className='text-7xl text-black'>PYTHON</h1>
<h2 className='text-xl'>A popular programming language
...
<button className='h-[40px] w-[200px] bg-pink-500 text-black  m-[8px] rounded-3xl'>Get Started</button>
 ...
 <div className='flex flex-col h-[400px] w-[400px] bg-slate-300'>
       <h1 className='text-2xl text-left text-black m-3 '>PYTHON Example</h1>
